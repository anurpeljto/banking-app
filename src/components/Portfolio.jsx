...
const Portfolio = () => {
  return (
    <section className='flex flex-col items-center justify-center gap-5'>
        ...
        <p className={`text-sm ${style.paragraph}`}><strong>NOTE:</strong> Many of these websites are deployed on render and other free hosting services. In case of lowered activity, these websites will slow down the servers. <br /> If the websites seem empty (no fetched data, like products), please refresh until they appear.</p>
